...
public class CrunchifyInMemoryCacheTest {
    ...
    private void crunchifyTestExpiredCacheObjects() throws InterruptedException {
        ...
        // maxItems = 10
        CrunchifyInMemoryCache<String, String> cache = new CrunchifyInMemoryCache<String, String>(10, 1, 1);
        ...
        Set<Object> set = cache.getCrunchifyCacheMap().entrySet();
        ...
        cache.getCrunchifyCacheMap().forEach(new BiConsumer<String, Object>() {
    ...
    private void crunchifyTestObjectsCleanupTime() throws InterruptedException {
        ...
        CrunchifyInMemoryCache<String, String> cache = new CrunchifyInMemoryCache<String, String>(5, 1, 500000);
